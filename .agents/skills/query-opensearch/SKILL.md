...
```bash
python .agents/skills/query-opensearch/query.py --discover
python .agents/skills/query-opensearch/query.py --discover github_issues_enriched github_pulls_enriched
```
...
```bash
python .agents/skills/query-opensearch/query.py \
...
```bash
python .agents/skills/query-opensearch/query.py --dsl github_repositories \
...
```bash
python .agents/skills/query-opensearch/query.py --dsl github_issues \
